...
module.exports = {
    ...
    rules: [
      ...
      // CSS
      {
        ...
        use: [
          ...
          {
            loader: 'css-loader',
            options: { modules: true, localIdentName, minimize: isProd }
          },
          {
            ...
            options: {
              plugins() {
                return [
                  postcssNested,
                  autoprefixer({
                    browsers: ['ie >= 11', 'iOS >= 8', 'Firefox >= 47']
                  })
                ]
              }
            }
  ...
  plugins: [
    ...
    new Copy([
      ...
      {
        from: 'node_modules/semantic-ui-css/themes/default/assets/',
        to: 'assets/themes/default/assets/'
      }
    ]),
    new IncludeAssetsPlugin({
      assets: ['assets/normalize.css', 'assets/semantic.min.css'],
      append: true
    }),
